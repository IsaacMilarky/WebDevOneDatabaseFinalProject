...
<html lang="en">
<head>
<title>Add Artist Guest to event - FinalProject</title>
...
function create_event() {
	...
	if(isset($_POST['new-event']) && isset($_POST['new-guest'])) {
		...
		$sql = "INSERT INTO ARTIST_GUESTS VALUES ('$guest', '$event');";
		
		$result = $db_connection->query($sql);
		
		if($result) {
			echo "<p>Successfully created added new artist guest to event.</p>";
		}
		else {
			echo "<p>Error adding artist guest:</p>";
