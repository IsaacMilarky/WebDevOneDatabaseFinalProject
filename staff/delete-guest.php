...
<html lang="en">
<head>
<title>Remove Customer From Event - FinalProject</title>
...
function delete_event() {
	...
	if(isset($_POST['event']) && isset($_POST['event'])) {
		...
		$sql = "DELETE FROM TYPICAL_GUESTS WHERE Event_time='$event' AND cid='$guest';";
		
		$result = $db_connection->query($sql);
		
		if($result) {
			echo "<p>Successfully removed guest from event.</p>";
		}
		else {
			echo "<p>Error deleting guest:</p>";
