...
function show_staff_controls() {
	...
	*/
	...
	echo "<form action=\"add-artist-guest.php\" method=\"post\">";
	...
	echo "</select>";
	echo "<input type=\"submit\" value=\"Add Artist Guest to Event\">";
	echo "</form></br>";
	
	
	$sql = "SELECT * FROM ARTIST_GUESTS";
	...
	foreach($result as $row) {
		...
		echo "<form action=\"update-artist-guest.php\" method=\"post\">";
		...
		echo "</select>";
		echo "<input type=\"submit\" value=\"Update Artist Guest Event Information\">";
		echo "<input type=\"submit\" value=\"Delete Artist Guest from Event\" formaction=\"delete-artist-guest.php\">";
		echo "</form>\n";
	}
}
